...
class BaseGraphQLResultNormalizer: GraphQLResultAccumulator {
  ...
  final func accept(scalar: JSONValue, firstReceivedAt: Date, info: FieldExecutionInfo) -> JSONValue? {
    return scalar
  }

  func accept(customScalar: JSONValue, firstReceivedAt: Date, info: FieldExecutionInfo) -> JSONValue? {
    return customScalar
  }

  final func acceptNullValue(firstReceivedAt: Date, info: FieldExecutionInfo) -> JSONValue? {
    return NSNull()
  }

  final func acceptMissingValue(firstReceivedAt: Date, info: FieldExecutionInfo) -> JSONValue? {
    return nil
  }
...
final class SelectionSetDataResultNormalizer: BaseGraphQLResultNormalizer {
  override final func accept(customScalar: JSONValue, firstReceivedAt: Date, info: FieldExecutionInfo) -> JSONValue? {
